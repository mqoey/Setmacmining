...
<!-- Mirrored from quomodosoft.com/html/nictorys/mechanical-works.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 17 Jul 2022 21:26:11 GMT -->
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="service-single.html">Power & energy</a></li>
                                    <li><a href="mechanical-works.html">Mechanical Works</a></li>
            ...
            <div class="row">
                <div class="col col-md-9 col-md-push-3">
                    <div class="service-single-content">
                        ...
                        <h2>Cyanide</h2>
                        <p>Cyanide is used to separate gold from ore. In its pure form, cyanide has no color and smells like
